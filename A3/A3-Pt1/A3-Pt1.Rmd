...
cyclones_data_update_2 <- cyclones_data_update_1 |>
    mutate(
        # YOUR CODE HERE
        date = make_datetime(ObservYear, Month, Day)
    )
...
In the chunk below, [**find the maximum and minimum sea ice extent for each year (by region)**]{.underline}. Pivot the data frame so that there's a column labelled "name" and a column labelled "value", as below.
